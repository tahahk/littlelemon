...
const Footer: FC<HTMLAttributes<HTMLElement>> = (props): JSX.Element => {
  return (
    <Container {...props}>
      <Content>
        ...
        <Column>
          ...
          <ul>
            ...
            <li>
              {" "}
              <a href="tel:+923211231231" target="_blank" rel="external">
                +92 321 1231231
              </a>{" "}
            </li>
            <li>
              {" "}
              <a
                href="mailto:taha@littlelemon.com"
                target="_blank"
                rel="external"
              >
                taha@littlelemon.com
              </a>{" "}
            </li>
          </ul>
        </Column>
        <Column>
          ...
          <ul>
            <li>
              {" "}
              <a
                href="https://www.facebook.com/people/Ankosi/100086324713409/"
                target="_blank"
                rel="external"
              >
                Facebook
      ...
      <Copyright>
        <span>Developed by M Taha Hassan.</span>
